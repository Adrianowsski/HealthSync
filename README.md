...
[![Tests – SQL](https://github.com/Adrianowsski/HealthSync/actions/workflows/tests-sql.yml/badge.svg)](https://github.com/Adrianowsski/HealthSync/actions/workflows/tests-sql.yml)
